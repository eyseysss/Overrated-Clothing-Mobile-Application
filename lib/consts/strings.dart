...
const forgotHint = "Enter your Email here..";
const resetpass = "Reset Password";
const wanttogoback = "Do you want to go Back?";
const password = "Password";
const passwordHint = "Enter your Password here..";
const retypePassword = "Retype Password";
const name = "Name";
const nameHint = "Enter your Name here..";
const forgetPass = "Forget Password";
const loginbut = "  Log in";
const login = "Log in";
const logout = "Log out";
const signup = "Sign up";
const signupWith = "Sign up with Google";
